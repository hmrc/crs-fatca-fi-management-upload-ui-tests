...
object FiAddressNonUK extends BasePage {

  override val pageUrl: String = baseUrl + "/address-non-uk"
  ...
  def enterAddressManually(): Unit = {
    ...
    sendTextById(city, "Some City")
    sendTextById(region, "Some Region")
    sendTextById(postCode, "A12 BC4")
    driver.findElement(country).click()
    driver.findElement(country).sendKeys("Andorra")
